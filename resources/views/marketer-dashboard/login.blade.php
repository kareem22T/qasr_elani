...
<!-- BEGIN LOGO -->
<div class="logo">
    <h2 style="color:white"><span style="color:red">Becleopatra - Marketer</span></h2>
</div>
<!-- END LOGO -->
...
<div class="content">
    {!!Form::open(['route'=> 'marketer.postLogin'])!!}
    <h3 class="form-title">Login to your account</h3>
    <div class="form-group">
        <label class="control-label visible-ie8 visible-ie9">phone</label>
        <div class="input-icon">
            <i class="fa fa-user"></i>
            <input id="phone" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="phone" name="phone"/>
        </div>
    </div>
    <div class="form-group">
    ...
    $(document).ready(function () {
        $('#btn-login').on('click', function (event) {
            ...
            if ($('#phone').val().trim() != '' && $('#password').val().trim() != '') {
                do_login("{{route('marketer.postLogin')}}");
            }
        });
    })
