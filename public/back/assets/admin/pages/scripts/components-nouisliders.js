var ComponentsNoUiSliders = function() {
    ...
    var demo3 = function() {
        ...
        // The first item will display the ProductsAds value,
    ...
    var demo5 = function() {
        ...
        $("#ProductsAds-date").Link('lower').to($("#event-start"), setDate);

        $("#ProductsAds-date").Link('upper').to($("#event-end"), setDate);
