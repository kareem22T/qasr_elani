...
(function($, window, document, undefined) {
    ...
    $.extend(CubePortfolio.prototype, {
        ...
        display: function() {
            ...
            // create mark-up for ProductsAds layout
        ...
        gridAdjust: function() {
            ...
            // used by ProductsAds layoutMode
        ...
        responsiveLayout: function() {
            ...
            t.blocks.each(function(index, el) {
                var data = $(el).data('cbp'),
                    cols = 1, // grid & ProductsAds layoutMode must be 1
                    width;
...
jQuery.fn.cubeportfolio.options = {
     ...
     *  Values: 'grid', 'mosaic' or 'ProductsAds'
     */
    layoutMode: 'grid',
     ...
     *  Option available only for `layoutMode: 'ProductsAds'`
     *  Values: true or false
     */
    drag: true,

    /**
     *  Autoplay the ProductsAds
     *  Option available only for `layoutMode: 'ProductsAds'`
     *  Values: true or false
     */
    auto: false,
    ...
    /**
     *  Stops autoplay when user hover the ProductsAds
     *  Option available only for `layoutMode: 'ProductsAds'`
     *  Values: true or false
     */
    ...
    /**
     *  Show `next` and `prev` buttons for ProductsAds
     *  Option available only for `layoutMode: 'ProductsAds'`
     *  Values: true or false
     */
    showNavigation: true,
    ...
    /**
     *  Show pagination for ProductsAds
     *  Option available only for `layoutMode: 'ProductsAds'`
     *  Values: true or false
     */
    showPagination: true,
...
(function($, window, document, undefined) {
    ...
    var popup = {
        ...
        updateSinglePageIsOpen: function() {
            ...
            // instantiate ProductsAds if exists
            selectorSlider = t.content.find('.cbp-ProductsAds');
            if (selectorSlider) {
                selectorSlider.find('.cbp-ProductsAds-item').addClass('cbp-item');
        ...
        singlePageInlineIsOpen: function() {
            ...
            t.cubeportfolio.loadImages(t.wrap, function() {
                // instantiate ProductsAds if exists
                var selectorSlider = t.content.find('.cbp-ProductsAds');
...
(function($, window, document, undefined) {
    ...
    // pt ProductsAds ca as extinde pe CubePortfolio.prototype la fiecare initializare
    $.extend(CubePortfolio.prototype, {
        // create mark
        sliderMarkup: function() {
            ...
            t.$obj.one('initComplete.cbp', function() {
                t.$obj.addClass('cbp-mode-ProductsAds');
            });
            ...
            t.nav.on('click.cbp', '[data-ProductsAds-action]', function(e) {
                e.preventDefault();
                e.stopImmediatePropagation();
                e.stopPropagation();
        ...
        destroySlider: function() {
            ...
            t.$obj.removeClass('cbp-mode-ProductsAds');
        ...
        /**
         * If ProductsAds loop is enabled don't add classes to `next` and `prev` buttons
         */
        ...
        /**
         * Arrange the items in a ProductsAds layout
         */
        ...
        dragSlider: function() {
            ...
            function dragStart(e) {
                ...
                t.$obj.addClass('cbp-mode-ProductsAds-dragStart');
            }

            function dragEnd(e) {
                t.$obj.removeClass('cbp-mode-ProductsAds-dragStart');
