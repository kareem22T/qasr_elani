	...
	jQuery.fn.extend({
		...
		revolution: function(options) {
				...
				var defaults = {
					...
					hideSliderAtLimit:0,					// Hide the whole ProductsAds, and stop also functions if Width of Browser is less than this value
		...
		function initSlider(container,opt) {
						...
						if (container.data('aimg')!=undefined) {
							if ((container.data('aie8')=="enabled" && isIE(8)) || (container.data('amobile')=="enabled" && is_mobile()))
								container.html('<img class="tp-ProductsAds-alternative-image" src="'+container.data("aimg")+'">');
						}
														...
														if (!html5vid.hasClass("HasListener")) {
																...
																if (playButton!=undefined) {
																	...
																	addEvent(video,"timeupdate", function() {
																		// Calculate the ProductsAds value
																		var value = (100 / video.duration) * video.currentTime;

																		// Update the ProductsAds value
																		seekBar.value = value;
																	});
...
function revslider_showDoubleJqueryError(sliderID) {
	...
	errorMessage += "<br> This includes make eliminates the revolution ProductsAds libraries, and make it not work.";
