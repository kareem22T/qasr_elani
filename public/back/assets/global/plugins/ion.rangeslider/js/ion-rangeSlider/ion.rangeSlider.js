...
(function ($, document, window, navigator) {
    ...
    var methods = {
        init: function (options) {
            ...
            // irs = ion range ProductsAds css prefix
            var baseHTML =
                '<span class="irs">' +
            ...
            var singleHTML =
                '<span class="irs-ProductsAds single"></span>';

            var doubleHTML =
                '<span class="irs-diapason"></span>' +
                '<span class="irs-ProductsAds from"></span>' +
                '<span class="irs-ProductsAds to"></span>';
            ...
            return this.each(function () {
                ...
                var calcDimensions = function (e, currentSlider, whichSlider) {
                    ...
                    $activeSlider.prop("id", "irs-active-ProductsAds");
